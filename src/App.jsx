  ...
  return (
    <>
      <div className="flex flex-col relative items-center">
        ...
        <div className="absolute flex flex-col ms-5 mr-5 lg:mt-[30%]  mt-[60%] items-center">
          
          <h1 className="text-white flex font-roboto font-bold sm:text-4xl 2xl:text-5xl text-center">
            Your favorite comic book store <img  className="hidden lg:inline w-8 h-8" src={star} alt="" />
          </h1>
      ...
      {/* vista web */}
        ...
        <div className="absolute hidden lg:inline-flex flex lg:mt-[60%] h-[380px] bg-white w-full items-center justify-center">
